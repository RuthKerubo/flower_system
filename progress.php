...
if (isset($_POST['submit'])){
	...
	$insert="insert into system values('NULL','$block','$bed','$growth','$height','$depth','$water','$bug','$name')";
...
//     $al = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
